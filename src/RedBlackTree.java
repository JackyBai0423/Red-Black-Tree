...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        } else throw new IllegalArgumentException("Unrelated nodes!");
    ...
    public void week05ActivityTestPart1() {
        ...
        node7.parent = node3;
        tree.rotate(node5, node2);
        // W U Y X T Z V
        if(!tree.root.toString().equals("[10, 9, 12, 8, 11, 13, 7]"))
    ...
    public void week05ActivityTestPart2() {
        ...
        tree.rotate(node2, node1);
        // X V W U Y T Z
        System.out.println(tree.root.toString());
        if(!tree.root.toString().equals("[8, 7, 10, 9, 12, 11, 13]"))
            fail("Failed the test.");
    }
	...
	public void week05ActivityTestPart3() {
		RedBlackTree<Integer> tree = new RedBlackTree<>();
		tree.insert(6);
		if(!tree.root.toString().equals("[6]"))
		  fail("Failed the test.");
		tree.insert(28);
		if(!tree.root.toString().equals("[6, 28]"))
      fail("Failed the test.");
		tree.insert(50);
    tree.rotate(tree.root.rightChild, tree.root);
		if(!tree.root.toString().equals("[28, 6, 50]"))
		  fail("Failed the test.");
		tree.insert(45);
		if(!tree.root.toString().equals("[28, 6, 50, 45]"))
		  fail("Failed the test.");
		tree.insert(23);
		if(!tree.root.toString().equals("[28, 6, 50, 23, 45]"))
      fail("Failed the test.");
